                    ...
                    <form>
                        ...
                        <div class="form-group row">
                            <div class="form-group col-md-4">
                                <label for="inputContinent"
                                       class="col-form-label text-white float-left">Continent</label>
                                <select id="inputContinent" class="form-control"
                                    ...
                                    {this.state.continentList && this.state.continentList.map(continentKey =>
                                        <option key={continentKey}
                                                value={continentKey}>{this.props.locations[continentKey]['continentName']}</option>
                                    )}
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                <label for="inputSubregion"
                                       class="col-form-label text-white float-left">Subregion</label>
                                ...
                                >
                                    {this.state.subregionList && this.state.subregionList.map(subregionKey =>
                                        <option key={subregionKey[0]}
                                                value={subregionKey[1]}>{capitalizeAllFirstLetter(subregionKey[0])}</option>
                                    )}
                                </select>
                            </div>
